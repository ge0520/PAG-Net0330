...
parser.add_argument('--save_dir', default='./save_nhh/nhhaze/', type=str, help='path to models saving')
parser.add_argument('--result_dir', default='./results/', type=str, help='path to results saving')
parser.add_argument('--folder', default='/home/geyt/dehaze/mixdehazenet/guanfang/test', type=str, help='folder name')
