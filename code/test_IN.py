...
# parser.add_argument('--save_dir', default='./save_INh/', type=str, help='path to models saving')
# parser.add_argument('--save_dir', default='./save_IN/', type=str, help='path to models saving')
parser.add_argument('--save_dir', default='./save_INMix/', type=str, help='path to models saving')


parser.add_argument('--result_dir', default='./results/', type=str, help='path to results saving')
# parser.add_argument('--dataset', default='/home/geyt/RESIDE/RESIDE-IN/', type=str, help='dataset name')
parser.add_argument('--dataset', default='/home/geyt/dehaze/DEA-Net/test_INO/', type=str, help='dataset name')
